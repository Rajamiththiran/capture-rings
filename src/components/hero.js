    ...
    <section className="mt-16" lazy="true">
      ...
      >
        <div className="text-center md:text-left md:w-1/2">
          ...
          <h1 className="text-7xl font-bold text-gray-800 font-domine">
          ...
          <div className="mt-6 flex justify-center md:justify-start">
            ...
            <button
              href="#"
              className="bg-pink-600 text-white px-6 py-3 rounded-3xl text-lg"
            >
              Our Gallery
            </button>
          </div>
      ...
      <div className="container mx-auto mt-12 flex flex-col md:flex-row items-center justify-around text-center md:text-left text-gray-800">
